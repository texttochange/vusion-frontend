...
#=======
  ...
  #config.vm.synced_folder "app", "/var/vusion/app",  type:"smb"
  #config.vm.synced_folder "app/Console", "/var/vusion/app/Console",  disabled: true
  #config.vm.synced_folder "app/Console/Command", "/var/vusion/app/Console/Command",  disabled:true
  #config.vm.synced_folder "app/Console/Command", "/var/vusion/app/Console/Command",  disabled:true
  config.vm.synced_folder "lib", "/var/vusion/lib",  disabled:true
  #config.vm.synced_folder "composer", "/var/vusion/composer",  type:"nfs" 
#>>>>>>> Stashed changes
