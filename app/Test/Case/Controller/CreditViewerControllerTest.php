...
*/
    ...
    public function testIndex_filters()
    {
        ...
        $this->HistoryTest->save(array(
            ...
            'timestamp' => '2012-02-08T12:40:43',
            'message-direction' => 'outgoing',
            'message-status' => 'delivered',
            'message-credits' => 1
            ));

        $this->HistoryTest->create('reques-history');
        $this->HistoryTest->save(array(
            'participant-phone' => '256712747843',
            'message-content' => 'Join',
            'timestamp' => '2012-02-07T12:40:43',
        ...
        $this->assertEquals(1, count($this->vars['programs'][0]['Program']['credits']['incoming']));
        $this->assertEquals(3, count($this->vars['programs'][0]['Program']['credits']['outgoing']));
...
/*
        ...
        $this->assertEquals(1, count($this->vars['programs']));
        $this->assertEquals(1, count($this->vars['programs'][0]['Program']['credits']['incoming']));
        $this->assertEquals(1, count($this->vars['programs'][0]['Program']['credits']['outgoing']));
  */      
