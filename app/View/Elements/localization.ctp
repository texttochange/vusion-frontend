...
var localized_labels = {
    ...
    "set-condition": "<?php echo __('Set condition(s) on Participant')?>",
    "all-subconditions": "<?php echo __('Match All condition(s)')?>",
    "any-subconditions": "<?php echo __('Match Any condition')?>",
    "subconditions": "<?php echo __('Conditions')?>",
    "subcondition": "<?php echo __('Condition')?>",
    ...
    "all-subconditions": "<?php echo __('All condition(s) have to be true')?>",
    "any-subconditions": "<?php echo __('Only one condition has to be true')?>",
