	...
	<table class="unmatchable-reply" cellpadding="0" cellspacing="0">
	    <thead>
	        <tr>                                                                        
			    ...
			    <th class="message-unmatchables"><?php echo $this->Paginator->sort('message-content', __('Message'));?></th>
		...
		<tbody>
			 ...
			 <tr>
			     ...
			     ?>
			     <td class="message-unmatchables"><?php echo $unmatchableReply['UnmatchableReply']['message-content']; ?>&nbsp;</td>
