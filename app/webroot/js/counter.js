function addCounter(){		
    $.each(
        ...
        function (key, elt){
            ...
            $("<span style='float: right; padding-right: 13px;'> <span class='counter' id="+$(elt).attr('name')+">"+$(elt).val().replace(/{.*}/g, '').length+"</span>"+localize_label('characters')+"</span>").insertBefore($(elt));
