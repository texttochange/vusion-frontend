var program = {"script": [ 
    ...
    "type-answer-action": {"optin":"optin", "optout": "optout", "enrolling":"enrolling",  "tagging":"tagging", "reset":"reset", "messaging":"messaging"},
    "add-request":"button",
    ...
    "type-action": {"optin": "optin", "optout": "optout", "enrolling":"enrolling",  "tagging":"tagging", "reset":"reset", "messaging":"messaging"},
    "choice":"text",
    "tagging":["tag"],
    "tag":"text",
    "enrolling":["enroll"],
    "enroll":"select",
    "messaging":["action-messaging-content"],
    "action-messaging-content":"textarea",
